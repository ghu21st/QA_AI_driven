...
class NRCTestDtmf(TestFixture):
    ...
    def test001_NRCDtmfGeneric1(self):
        ...
        #
        test_record_1 = kafka.create_messages_record(recogInit=test_dtmfrecInit, expected_result=test_expect)
        test_record_1.set_checklist_types("DTMF")
        ...
        test_record_1.add_token_to_checklist(evnt="SWIgrld", token="URI", value="builtin:dtmf/digits")
    ...
    def test004_NRCDtmf_Number(self):
        ...
        test_record_1.set_checklist_types("DTMF")
        test_record_1.add_expression_to_checklist(test_expect)
        test_record_1.add_token_to_checklist(evnt="SWIgrld", token="URI", value="builtin:dtmf/number")
        test_record_1.add_token_to_checklist(evnt="SWIrslt", token="CNTNT", value=test_expect)
        try:
    ...
    def test042_NRCDtmf_TwoDTMF_Noactivity_between(self):
        ...
        test_record_1 = kafka.create_messages_record(test_dtmfrecInit, test_expect)
        test_record_1.set_checklist_types("DTMF")
        test_record_1.add_event_to_checklist("audioDurationMs", "\d{5}")
    ...
    def test0101_NRCDtmf_long_duration(self):
        ...
        test_record_1 = kafka.create_messages_record(test_dtmfrecInit, test_expect1)
        ...
        try:
            ...
            self.assertRecognitionResult(inputToCheck=test_result, expectResult=test_expect2)
            # validate via kafka log
            kafka.validate_callLogs(test_record_1, "audioDurationMs=20000")
    ...
    def test0102_NRCDtmf_boolean(self):
        ...
        test_record_1.add_expression_to_checklist(test_expect)
        test_record_1.add_token_to_checklist(evnt="SWIgrld", token="PROPS", value="swirec_language=en-US")
        test_record_1.add_token_to_checklist(evnt="SWIgrld", token="URI", value="builtin:dtmf/boolean")
        test_record_1.add_token_to_checklist(evnt="SWIrslt", token="CNTNT", value=test_expect) 
        try:
    ...
    def test0103_NRCDtmf_grammar_creditcard(self):
        ...
        test_expect1 = "<result><interpretation grammar=.+builtin:dtmf\/creditcard.+\/result>"
        #
        test_record_1 = kafka.create_messages_record(recogInit=test_dtmfrecInit, expected_result=test_expect1)
        test_record_1.set_checklist_types("DTMF")
        test_record_1.add_expression_to_checklist(test_expect1)
        #test_record_1.add_token_to_checklist(evnt="SWIgrld", token="PROPS", value="swirec_language=en-US")
        #test_record_1.add_token_to_checklist(evnt="SWIrslt", token="CNTNT", value=test_expect)
        test_record_1.add_token_to_checklist(evnt="SWIgrld", token="URI", value="builtin:dtmf/creditcard")
    ...
    def test0104_NRCDtmf_grammar_date(self):
        ...
        test_expect1 = "<result><interpretation grammar=.+builtin:dtmf\/date.+\/result>"
        #
        test_record_1 = kafka.create_messages_record(test_dtmfrecInit, test_expect1)
        test_record_1.set_checklist_types("DTMF")
        test_record_1.add_expression_to_checklist(test_expect1)
        test_record_1.add_token_to_checklist(evnt="SWIgrld", token="URI", value="builtin:dtmf/date")
        test_record_1.add_token_to_checklist(evnt="SWIrslt", token="CNTNT", value=test_expect1)
#        test_record_1.add_token_to_checklist(evnt="SWIrslt", token="CNTNT", value="grammar=.+builtin:dtmf\/date")
    ...
    def test0105_NRCDtmf_grammar_time(self):
        ...
        test_expect1 = "<result><interpretation grammar=.+builtin:dtmf\/time.+\/result>"
        #
        test_record_1 = kafka.create_messages_record(test_dtmfrecInit, test_expect1)
        test_record_1.set_checklist_types("DTMF")
        test_record_1.add_expression_to_checklist(test_expect1)
        test_record_1.add_token_to_checklist(evnt="SWIgrld", token="URI", value="builtin:dtmf/time")
        test_record_1.add_token_to_checklist(evnt="SWIrslt", token="CNTNT", value=test_expect1)
    ...
    def test0106_NRCDtmf_grammar_currency(self):
        ...
        test_record_1.set_checklist_types("DTMF")
        test_record_1.add_expression_to_checklist(test_expect)
        test_record_1.add_token_to_checklist(evnt="SWIgrld", token="URI", value="builtin:dtmf/currency")
        test_record_1.add_token_to_checklist(evnt="SWIrslt", token="CNTNT", value=test_expect)
    ...
    def test0108_NRCDtmf_grammar_postcode(self):
        ...
        test_record_1.set_checklist_types("DTMF")
        test_record_1.add_expression_to_checklist(test_expect)
        test_record_1.add_token_to_checklist(evnt="SWIgrld", token="URI", value="builtin:dtmf/postcode")
        test_record_1.add_token_to_checklist(evnt="SWIrslt", token="CNTNT", value=test_expect)
    ...
    def test0109_NRCDtmf_grammar_socialsecurity(self):
        ...
        test_record_1.set_checklist_types("DTMF")
        test_record_1.add_expression_to_checklist(test_expect)
        test_record_1.add_token_to_checklist(evnt="SWIgrld", token="URI", value="builtin:dtmf/socialsecurity")
        test_record_1.add_token_to_checklist(evnt="SWIrslt", token="CNTNT", value=test_expect)
    ...
    def test0110_NRCDtmf_grammar_phone(self):
        ...
        test_record_1.set_checklist_types("DTMF")
        test_record_1.add_expression_to_checklist(test_expect)
        test_record_1.add_token_to_checklist(evnt="SWIgrld", token="URI", value="builtin:dtmf/phone")
        test_record_1.add_token_to_checklist(evnt="SWIrslt", token="CNTNT", value=test_expect)
    ...
    def test0111_NRCDtmf_grammar_ccexpdate(self):
        ...
        test_record_1.set_checklist_types("DTMF")
        test_record_1.add_expression_to_checklist(test_expect)
        test_record_1.add_token_to_checklist(evnt="SWIgrld", token="URI", value="builtin:dtmf/ccexpdate")
        test_record_1.add_token_to_checklist(evnt="SWIrslt", token="CNTNT", value=test_expect)
    ...
    def test0112_NRCDtmf_secure_context_level_open(self):
        ...
        test_record_1.add_expression_to_checklist(test_expect)
        test_record_1.add_token_to_checklist(evnt="SWIgrld", token="URI", value="builtin:dtmf/digits")
        test_record_1.add_token_to_checklist(evnt="SWIrslt", token="CNTNT", value="grammar=.+builtin:dtmf\/digits")
