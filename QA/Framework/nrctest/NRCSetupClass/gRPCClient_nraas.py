...
class gRPCClient:
    ...
    def __init__(self, gRPC_server=None, gRPCs_port=None, gRPC_port=None):
        ...
        if not self._nrctest_:
            ...
            with open('/package/unarchive/Framework/nrctest/NRCSetupClass/cacert.pem', 'rb') as certFile:
        ...
        # check if for NRC test with secure connect
            ...
            with open('/package/unarchive/Framework/nrctest/NRCSetupClass/nrc.crt', 'rb') as certFile:
                trust_certs = certFile.read()
